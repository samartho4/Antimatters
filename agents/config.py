...
class RetryConfig:
    ...
    Increased retries for peak hour testing.
    """
    max_retries: int = 8  # Up to 8 retry attempts (was 5)
    initial_delay: float = 3.0  # Start with 3-second delay (was 2.0)
    ...
    retryable_codes: List[int] = field(default_factory=lambda: [503, 429])
...
class ModelConfig:
    ...
    """
    research: str = GeminiModel.FLASH_2_5.value  # Separate quota bucket
    engineering: str = GeminiModel.PRO_3.value  # Complex docking orchestration
    evolution: str = GeminiModel.PRO_3.value  # SAR discovery + molecule generation
    coordinator: str = GeminiModel.PRO_3.value  # Different quota bucket
